...
// 		RegexNode root = ImportRegex.apply(regex);
// 		Nfa nfa = Follow.apply(root);
		// You can use nfa.start.reachable() to get a set of all nodes, which
		// can then be mapped to output nodes.
		return null;
	}
}
